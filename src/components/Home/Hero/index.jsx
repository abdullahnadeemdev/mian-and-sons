  ...
  return (
    <div className="relative">
      <div className="h-screen flex items-center justify-center relative">
        <div className="bg-black/75 xl:rounded-2xl absolute flex items-center justify-center font-semibold z-10 h-screen w-full"></div>
        ...
        <img
          ...
          className="xl:rounded-2xl h-full w-full object-cover"
          fetchPriority="high"
          decoding="async"
        />
      </div>
